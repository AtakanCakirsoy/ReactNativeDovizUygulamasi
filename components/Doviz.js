        ...
        axios.get('https://finans.truncgil.com/today.json')
            .then(response => {
                ...
                for (var i in response.data) {
                    if (response.data[i]["Tür"] === "Döviz" && i !== "ÖZEL ÇEKME HAKKI (SDR)                            ") {
                ...
                //eski kaynaktan api alırken, en alttaki kod ile alabiliyorduk. Çünkü o array şeklinde geliyordu ve
                //sorun olmuyordu. Ancak obje olarak gelince üstteki gibi almak zorunda kaldık.
        ...
        return (
            <View style={mainView}>
                <View style={headerView}>
                    <Header headerText={strings.Doviz} />
                </View>
